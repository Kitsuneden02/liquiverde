...
api_router.include_router(products_router, prefix="/products", tags=["Productos y Escáner"])
...
api_router.include_router(stores_router, prefix="/stores", tags=["Tiendas y Geolocalización"])
